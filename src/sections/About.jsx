...
const About = () => {
  return (
    <div
      ...
      id="about"
    >
      <div className="flex flex-col h-[70vh] py-4 w-full items-center gap-4 mx-44 max-sm:mx-8 justify-center rounded-3xl backdrop-blur-sm  dark:text-black text-white bg-black/70 dark:bg-white/30 transition-all duration-500 max-sm:flex-col max-sm:gap-2 max-2xl:gap-2">
