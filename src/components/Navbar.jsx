...
const Navbar = () => {
  ...
  return (
    <div className="py-6 flex px-28 justify-between items-center text-white backdrop-blur-sm bg-black/70 max-sm:flex max-sm:justify-center max-sm:px-10 font-quatt">
      <h1 className="text-5xl w-60 font-bold max-sm:hidden"> <a href="/"><NavTitle/> </a></h1>
