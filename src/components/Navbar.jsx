...
const Navbar = () => {
  ...
  return (
    <div className="py-10 flex px-28 justify-between items-center text-white ">
      <h1 className="text-4xl w-60 font-bold uppercase ">Glendy´s Portfolio Web Developer</h1>
      <ul className="flex gap-5 list-none text-sm uppercase font-medium max-sm:justify-between max-sm:gap-2 max-sm:hidden">
        <a href="#about" onClick={() => setHome("home")} className={home==="home" ? "pb-px border-solid border-b-2 border-white cursor-pointer" : "cursor-pointer"}>About</a>
