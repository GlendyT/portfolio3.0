    ...
    >
        ...
        <div className="flex flex-col gap-2 justify-center pt-2 pb-2">
          <div className=" grid grid-cols-2 gap-2  max-sm:text-xs ">
            <div className="border-2 border-solid border-slate-600 rounded-2xl p-2">
              ...
              <a href="https://themagicshop.vercel.app/" target="_blanck" className="hover:text-purple-500">
          ...
          <p className=" max-sm:text-xs max-2xl:text-xs">
            I am a student of Systems Engineering, Web developer and starting in
            the world of Mobile Application Development, which is where I can
            find my self doing one of the things that I love. Coding, searching
            and solving errors is enjoyable to me. I am a positive, curious and
            hard working person, trying always to help and share my acknowladge
            and at the same time improving my soft and technical skills.
          </p>
        </div>
      </div>
      <div className="m-auto flex items-center justify-center relative max-md:hidden">
        <img
          src={GT}
          alt="GT"
          className=" w-7/12 rounded-xl max-sm:hidden  max-2xl:hidden"
        />
      </div>
    </div>
  );
